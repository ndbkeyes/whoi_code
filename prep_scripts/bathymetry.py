...
def bathymetry(lvl):
    ...
    # load file that we made holding all data in organized object
    file = 'C:/Users/ndbke/Dropbox/_NDBK/Research/WHOI/whoi_code/NetCDFs/data_all.nc'
    ...
    full_bath = xr.apply_ufunc(find_bottom, dat.CT, dat.depth, input_core_dims=[["depth"],["depth"]], vectorize=True)
    print(full_bath)
    full_bath.plot()
    ...
    dat.to_netcdf('../NetCDFs/bathymetry.nc',mode='w')
